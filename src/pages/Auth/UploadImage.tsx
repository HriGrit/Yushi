    ...
    return (
        <div className="text-center">
            ...
            <div className='flex justify-center gap-8'>
                <label className='text-neutral-500 font-bold my-2 text-center flex w-full gap-4'>
                    <button id="btn1" onClick={handleUploadClick} className='bg-primary-400 w-1/2 rounded-lg px-4 py-2'>Select Photo</button>
                    <button id="btn2" onClick={handleUpload} className='bg-primary-400 w-1/2 rounded-lg px-4 py-2'>Upload Photo</button>
                </label>
                {imageUrl && (
                    <button onClick={handleCancel} className='bg-theme text-neutral-500 font-bold my-2 bg-primary-400 w-full rounded-lg px-4 py-2 text-center cursor-pointer'>
                        Cancel
                    </button>
                )}
            </div>
